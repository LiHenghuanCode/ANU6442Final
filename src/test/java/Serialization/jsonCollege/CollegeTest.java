...
public class CollegeTest {
	...
	private static final String JSON_FILE = "src/test/java/Serialization/jsonCollege/college.json";
	private static final String PROCESSED_JSON_FILE = "src/test/java/Serialization/jsonCollege/college_processed.json";
