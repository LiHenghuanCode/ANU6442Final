package Serialization.CompanyJson;


import Serialization.jsonCompany.Company;
...
public class CompanyTest {
	...
	private static final String JSON_FILE = "src/test/java/Serialization/CompanyJson/company.json";
	private static final String PROCESSED_JSON_FILE = "src/test/java/Serialization/CompanyJson/company_processed.json";
